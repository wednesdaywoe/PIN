...
The question exists because of effect 15253 (Charge's camera lock, `Docs/In-Game-Tests.md` D5).
...
fix — the test entries live in `Docs/In-Game-Tests.md` under "Prediction reconciliation sweep".
