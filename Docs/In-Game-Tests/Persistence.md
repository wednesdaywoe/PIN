...
## [ ] C2: The save file says what it should
...
## [ ] C3: Nothing doubles when you relog twice
...
## [ ] C4: You come back where you left
...
## [ ] C5: A session that never logs out still keeps its crystite
...
## [ ] C7: A broken save doesn't stop you logging in
