...
which [N3](../../Game Testing/NPC-Combat.html) found the hard way. There is no ground to query, no cover
...
reports grounded inside terrain exactly as it does on top of it** — [N16](../../Game Testing/NPC-Combat.html)
