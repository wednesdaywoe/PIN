...
[W1](../../Game Testing/Constraints-Transport.html) showed unknown JSON keys survive the engine's
...
[W1](../../Game Testing/Constraints-Transport.html), run 2026-08-14. Route 2 is open. The same run
