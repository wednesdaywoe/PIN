...
[Session Setup](../../Game Testing/Session-Setup.html) already recorded the consequence before this
...
Code complete and unverified in game. [C1–C7](../../Game Testing/Persistence.html) are the check, and
...
the reason [I3](../../Game Testing/Inventory.html) suspects the bag is full: PIN hands out every frame in
the game, which no retail character carried. Persistence is what makes it possible to stop doing
that, so [I1](../../Game Testing/Inventory.html) may come unstuck as a side effect of a later cut here.
...
thing [I3](../../Game Testing/Inventory.html) suspects of breaking item delivery: PIN gives out all 20
