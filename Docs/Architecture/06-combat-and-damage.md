...
left of the directed curve, which is inferred rather than read — [E3](../../Game Testing/Environment.html)
is what confirms it.
...
- `target`, `cleartarget`, `npc`, `applyeffect`, `listeffects`, `removeeffect`, `cflags`,
  ...
  Admin chat channel without a leading slash. [In-Game Tests](../../Game Testing/Session-Setup.html)
